...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `deta_moyenne` ()  BEGIN
SELECT TRUNCATE(AVG(DATEDIFF(commande.date_paiement, commande.date_commande)),2) FROM commande WHERE commande_etat = 'livrer';
END$$
...
INSERT INTO `commande` (`commande_id`, `adresse_facturation`, `adresse_livraison`, `date_commande`, `date_paiement`, `commande_etat`, `livraison_id`, `facture_id`, `total_HT`, `total_TTC`) VALUES
(1, '911-2323 Eleifend St.', '547-1485 Lobortis, Road', '2021-11-18 14:26:05', '2021-11-21', 'livrer', '1', 1, 520, NULL),
(2, '794-7896 At Ave', 'Ap #764-4246 Cras Road', '2022-02-03 06:22:27', '2022-02-06', 'en cours', NULL, NULL, 255, NULL),
(3, 'Ap #759-5030 Varius Av.', '236-3923 Cursus Rd.', '2022-09-27 14:07:19', '2022-10-28', NULL, NULL, NULL, NULL, NULL),
(4, '871-9682 Tincidunt Road', 'Ap #624-1047 Arcu. Avenue', '2022-05-13 14:22:59', '2021-07-22', NULL, NULL, NULL, NULL, NULL),
(5, 'Ap #882-8621 Non, St.', 'Ap #428-4573 Consectetuer, Avenue', '2022-10-08 17:48:20', '2022-04-04', NULL, NULL, NULL, NULL, NULL),
(6, '628-3869 Arcu. Road', 'Ap #224-5919 In St.', '2021-10-31 00:37:02', '2022-07-30', NULL, NULL, NULL, NULL, NULL),
(7, '7607 Ac, Avenue', '589-4808 Enim St.', '2021-12-08 16:41:53', '2021-10-27', NULL, NULL, NULL, NULL, NULL),
(8, 'Ap #763-2056 Posuere Street', 'P.O. Box 270, 5479 Est Ave', '2022-04-11 00:55:57', '2022-01-10', NULL, NULL, NULL, NULL, NULL),
(9, 'Ap #811-5216 Cras Rd.', 'Ap #926-1023 Egestas. Street', '2023-01-09 04:13:42', '2021-12-06', NULL, NULL, NULL, NULL, NULL),
(10, '174-9238 Eget Rd.', 'Ap #678-6728 Non, St.', '2021-03-12 17:16:27', '2022-12-31', NULL, NULL, NULL, NULL, NULL),
(11, '4588 Orci. St.', 'Ap #263-6431 Adipiscing St.', '2022-10-13 07:16:50', '2022-10-16', NULL, NULL, NULL, NULL, NULL),
(12, '336-2827 Quam. St.', 'P.O. Box 749, 6726 Donec St.', '2023-02-26 10:18:54', '2021-06-04', NULL, NULL, NULL, NULL, NULL),
(13, '251-2538 Sed Rd.', 'Ap #376-6838 Elementum Rd.', '2022-11-20 07:22:49', '2021-09-09', NULL, NULL, NULL, NULL, NULL),
(14, '443-352 Arcu. Road', 'Ap #624-9427 Natoque Street', '2022-06-08 19:53:50', '2021-05-19', NULL, NULL, NULL, NULL, NULL),
(15, 'Ap #370-489 Risus. Street', 'Ap #902-9867 Vestibulum, Road', '2023-03-09 03:59:46', '2023-02-18', NULL, NULL, NULL, NULL, NULL),
(16, 'P.O. Box 407, 3269 Natoque Street', 'P.O. Box 471, 2405 Volutpat Avenue', '2022-03-23 10:16:11', '2022-01-17', NULL, NULL, NULL, NULL, NULL),
(17, '988 Ut, Rd.', '532-9439 Condimentum. Road', '2022-09-17 16:21:37', '2022-03-22', NULL, NULL, NULL, NULL, NULL),
(18, 'P.O. Box 888, 9299 Nascetur Avenue', '1950 Justo. Street', '2021-08-12 18:32:19', '2021-08-29', NULL, NULL, NULL, NULL, NULL),
(19, 'P.O. Box 962, 6704 Amet, St.', '200-2356 Lorem Ave', '2021-11-08 10:03:44', '2021-10-22', NULL, NULL, NULL, NULL, NULL),
(20, '916-9102 Ac Road', 'P.O. Box 978, 4330 Suspendisse St.', '2021-10-04 05:34:30', '2022-08-28', NULL, NULL, NULL, NULL, NULL),
(21, 'Ap #652-1025 Pede Rd.', 'Ap #944-2494 Interdum Rd.', '2021-12-25 12:47:53', '2023-01-12', NULL, NULL, NULL, NULL, NULL),
(22, 'P.O. Box 242, 5913 A Rd.', '372-8455 Pede Street', '2021-03-27 03:09:53', '2021-04-30', NULL, NULL, NULL, NULL, NULL),
(23, '181-4246 Consequat Avenue', '5956 Magna. St.', '2022-10-01 07:53:23', '2022-09-23', NULL, NULL, NULL, NULL, NULL),
(24, '452-9309 Cras Road', 'P.O. Box 181, 7336 Ac Road', '2021-08-14 08:11:18', '2021-10-18', NULL, NULL, NULL, NULL, NULL),
(25, 'Ap #679-6085 Tortor. St.', 'Ap #796-1744 Fringilla St.', '2021-12-06 10:30:12', '2021-06-24', NULL, NULL, NULL, NULL, NULL),
(26, '860-9471 Nulla. Road', 'Ap #783-9495 Sed Av.', '2022-01-18 12:45:05', '2023-01-15', NULL, NULL, NULL, NULL, NULL),
(27, 'Ap #234-967 Phasellus Rd.', 'Ap #629-9163 Aptent Ave', '2021-04-21 20:17:40', '2021-10-02', NULL, NULL, NULL, NULL, NULL),
(28, 'Ap #616-4051 Nulla St.', '699-517 Et Street', '2022-01-20 23:01:57', '2022-10-23', NULL, NULL, NULL, NULL, NULL),
(29, '518-7950 Fames St.', 'Ap #999-1097 Lobortis St.', '2022-04-11 01:41:01', '2022-02-05', NULL, NULL, NULL, NULL, NULL),
(30, '9512 Sagittis. Rd.', '782-4341 Dolor. Street', '2022-05-09 02:04:52', '2023-01-29', NULL, NULL, NULL, NULL, NULL),
(31, 'Ap #840-6834 Natoque Rd.', 'Ap #468-7788 Lorem St.', '2021-04-20 04:31:34', '2021-08-13', NULL, NULL, NULL, NULL, NULL),
(32, 'Ap #686-8856 Laoreet, Avenue', 'P.O. Box 819, 3690 Ante. Street', '2021-11-03 02:09:27', '2022-09-08', NULL, NULL, NULL, NULL, NULL),
(33, '174-9185 Nec St.', '507-9535 Sollicitudin St.', '2021-07-11 12:37:16', '2023-01-23', NULL, NULL, NULL, NULL, NULL),
(34, '886-3349 Sapien, Ave', 'Ap #434-7465 Ac St.', '2021-12-02 12:52:51', '2022-04-28', NULL, NULL, NULL, NULL, NULL),
(35, '614-5330 Ornare. Rd.', '327-4444 Ultricies St.', '2021-10-13 12:04:36', '2021-04-15', NULL, NULL, NULL, NULL, NULL),
(36, 'Ap #205-6226 Auctor St.', 'Ap #278-5404 Donec Ave', '2021-12-21 18:29:04', '2022-07-17', NULL, NULL, NULL, NULL, NULL),
(37, '897-430 Convallis Av.', 'Ap #127-5557 Purus, St.', '2023-01-26 13:10:10', '2022-08-04', NULL, NULL, NULL, NULL, NULL),
(38, 'Ap #172-9724 Purus. St.', '784-7644 Ipsum. Av.', '2023-01-27 14:41:11', '2022-01-24', NULL, NULL, NULL, NULL, NULL),
(39, 'Ap #700-5511 Imperdiet Av.', '227-2794 Pede, Street', '2022-12-22 18:55:07', '2023-02-23', NULL, NULL, NULL, NULL, NULL),
(40, 'Ap #497-2576 Elit. St.', 'Ap #910-6214 Magna. Street', '2022-11-06 21:28:20', '2021-11-05', NULL, NULL, NULL, NULL, NULL),
(41, '3315 Nullam Road', 'Ap #504-7915 Duis Av.', '2023-01-21 08:43:48', '2023-01-02', NULL, NULL, NULL, NULL, NULL),
(42, 'Ap #284-2711 Ligula Road', 'P.O. Box 567, 1534 Elit, Av.', '2023-02-11 07:15:38', '2022-08-01', NULL, NULL, NULL, NULL, NULL),
(43, '673-1948 Orci St.', '355-8240 Etiam Avenue', '2021-12-02 22:45:24', '2021-06-24', NULL, NULL, NULL, NULL, NULL),
(44, 'Ap #206-8492 Dolor Road', 'Ap #611-5050 Luctus Street', '2022-01-18 04:01:39', '2022-12-17', NULL, NULL, NULL, NULL, NULL),
(45, '4516 Aliquam St.', '3768 Lorem. Street', '2022-04-25 02:35:42', '2022-12-25', NULL, NULL, NULL, NULL, NULL),
(46, 'P.O. Box 476, 9767 Lorem Road', '663-4333 Nisi. Rd.', '2021-03-28 09:53:57', '2021-11-19', NULL, NULL, NULL, NULL, NULL),
(47, '169-8603 Nulla St.', '4674 Risus. Rd.', '2021-12-08 03:58:02', '2021-09-05', NULL, NULL, NULL, NULL, NULL),
(48, '107-9238 Fringilla Avenue', '5156 Sed St.', '2022-08-17 07:43:27', '2022-02-06', NULL, NULL, NULL, NULL, NULL),
(49, 'Ap #829-2224 Aliquam Av.', '592-321 Fringilla. St.', '2022-07-15 20:05:54', '2021-06-06', NULL, NULL, NULL, NULL, NULL),
(50, '486-8560 Phasellus St.', '3497 Vitae Av.', '2021-10-29 21:47:51', '2022-06-08', NULL, NULL, NULL, NULL, NULL),
(51, 'azrz zafzaeaz', 'zaezrrte trhezr', '2022-03-10 16:20:03', '2022-05-10', 'en cours', '2', 2, NULL, NULL);
...
INSERT INTO `facture` (`facture_id`, `facture_date_paiement`, `facture_ref`) VALUES
(1, '2022-03-14', 'REFAQJDUEZ'),
(2, '2022-03-19', 'AONFEIOAKS');
...
INSERT INTO `livraison` (`livraison_id`, `livraison_date_livraison`) VALUES
('1', '2022-03-14 11:24:44'),
('2', '2022-03-14 11:26:29');
...
CREATE TABLE `passe` (
  ...
  `total_ligne` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `passe` (`produit_id`, `client_id`, `commande_id`, `reduction`, `date_achat`, `quantite`, `total_ligne`) VALUES
(3, 14, 2, NULL, '2022-03-14', 5, 255),
(6, 1, 1, NULL, '2022-03-10', 10, 390),
(19, 1, 1, NULL, '2022-03-10', 5, 130);
...
--
-- Stand-in structure for view `produit_fournisseur`
...
,`produit_prix` decimal(15,2)
,`produit_photo` varchar(50)
,`produit_description` varchar(300)
,`stock_nom` varchar(50)
,`stock_quantite` int(11)
...
INSERT INTO `stock` (`stock_id`, `stock_nom`, `stock_quantite`, `fournisseur`) VALUES
(1, NULL, 0, 'FourniL'),
(2, NULL, 211, NULL),
(3, NULL, 488, NULL),
(4, NULL, 121, NULL),
...
--
-- Structure for view `produit_fournisseur`
--
DROP TABLE IF EXISTS `produit_fournisseur`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `produit_fournisseur`  AS  select `produit`.`produit_id` AS `produit_id`,`produit`.`produit_libelle` AS `produit_libelle`,`produit`.`produit_reference` AS `produit_reference`,`produit`.`produit_prix` AS `produit_prix`,`produit`.`produit_photo` AS `produit_photo`,`produit`.`produit_description` AS `produit_description`,`stock`.`stock_nom` AS `stock_nom`,`stock`.`stock_quantite` AS `stock_quantite`,`stock`.`fournisseur` AS `fournisseur` from (`produit` left join `stock` on((`produit`.`stock_id` = `stock`.`stock_id`))) ;
...
ALTER TABLE `appartient`
  ADD PRIMARY KEY (`categorie_id`,`categorie_id_1`),
...
ALTER TABLE `client`
  ...
  ADD KEY `coef_id` (`coef_id`),
  ADD KEY `commercial_id` (`commercial_id`);

--
-- Indexes for table `coef`
--
ALTER TABLE `coef`
...
ALTER TABLE `facture`
  ...
  ADD UNIQUE KEY `facture_ref` (`facture_ref`);
...
--
ALTER TABLE `passe`
  ADD PRIMARY KEY (`produit_id`,`client_id`,`commande_id`),
...
--
ALTER TABLE `commercial`
  MODIFY `commercial_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `produit`
  MODIFY `produit_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
